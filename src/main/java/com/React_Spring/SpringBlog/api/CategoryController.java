...
public class CategoryController {
	...
	@GetMapping(path="{id}")
	public Optional<Category> getOneById(@PathVariable("id") Long id) {
	...
	@PutMapping(path="{id}")
	public void updateCategory(@Validated @NonNull @RequestBody Category category, @PathVariable("id") Long id) {
